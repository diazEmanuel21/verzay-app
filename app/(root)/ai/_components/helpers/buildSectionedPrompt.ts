                ...
                if (cfg.mode === "management") {
                    ...
                    out.push(
                        [
                            ...
                            `* **Campos a registrar (comunes):** en \`DETALLES\` *(string, una sola línea)* → **resumen unificado** con todos los datos recolectados del usuario *(nombre, documento, descripción de la solicitud, notas, etc.)* en formato \`Clave: Valor\` separado por \`, \`.`,
