...
export const createUserWithPausar = async (
    ...
    try {
        ...
        // Corrected way to set default values, ensuring existing userFields have precedence.
        const safeUserFields = {
            ...userFields,
            onFacebook: userFields.onFacebook ?? false,
            onInstagran: userFields.onInstagran ?? false,
            muteAgentResponses: userFields.muteAgentResponses ?? false,
        };
...
export async function deleteUser(id: string) {
    ...
    try {
        await db.$transaction(async (tx) => {
            ...
            await tx.seguimientos.deleteMany({ where: { apikey: id } });
